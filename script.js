...
let roomName = "observable-" + prompt("Если вы создаете чат, то введите, пожалуйста, номер комнаты, который вы придумаете, и сообщите его тому, с кем хотите переписываться. Если вас приглашают в чат, то введите номер комнаты приглашающего вас.");
let userName = prompt("Ваше имя в чате? Любой ник, который вам по душе" ) || "no_name";
